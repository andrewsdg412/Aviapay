package com.android.aviapay.lib.stagedview;
...
/**
 * zhouqiang by 20170316
 */
public class StaggedGridView extends ExtendableListView {

    private static final String TAG = "StaggedGridView";
    ...
    public StaggedGridView(final Context context) {
        this(context, null);
    }

    public StaggedGridView(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StaggedGridView(final Context context, final AttributeSet attrs, final int defStyle) {
